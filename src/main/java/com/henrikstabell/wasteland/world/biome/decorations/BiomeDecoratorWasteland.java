package com.henrikstabell.wasteland.world.biome.decorations;

import com.henrikstabell.wasteland.WastelandEventHandler;
import com.henrikstabell.wasteland.config.WastelandConfig;
import com.henrikstabell.wasteland.world.biome.*;
import com.henrikstabell.wasteland.world.biome.decorations.gen.WorldGenOasis;
import com.henrikstabell.wasteland.world.biome.decorations.gen.WorldGenRandomFire;
import com.henrikstabell.wasteland.world.biome.decorations.gen.WorldGenRandomRubble;
import com.henrikstabell.wasteland.world.biome.decorations.gen.WorldGenWastelandBigTree;
import com.henrikstabell.wasteland.world.biome.decorations.gen.ruins.WorldGenCivilizationRuins;
import com.henrikstabell.wasteland.world.biome.decorations.gen.ruins.WorldGenRuinedRuins;
import com.henrikstabell.wasteland.world.biome.decorations.gen.ruins.WorldGenSurvivalTent;
import com.henrikstabell.wasteland.world.biome.decorations.gen.ruins.WorldGenTreeHouse;
import com.henrikstabell.wasteland.world.biome.decorations.gen.ruins.city.WorldGenFireStation;
import com.henrikstabell.wasteland.world.biome.decorations.gen.ruins.city.WorldGenRadioTower;
import com.henrikstabell.wasteland.world.biome.decorations.gen.ruins.city.WorldGenScrapYard;
...
public class BiomeDecoratorWasteland extends BiomeDecorator {
    ...
    // City
    public WorldGenerator radioTower = new WorldGenRadioTower();
    public WorldGenerator fireStation = new WorldGenFireStation();
    public WorldGenerator scrapYard = new WorldGenScrapYard();
    ...
    private void decorateForest(World world, Random random) {
        if (random.nextInt(WastelandConfig.worldgen.forestRuinRarity * 3) == 0) {
            this.tent.generate(world, random, world.getHeight(this.position.add(random.nextInt(16), 0, random.nextInt(16))));
        }

        if (random.nextInt(WastelandConfig.worldgen.forestRuinRarity * 2) == 0) {
            this.treeHouse.generate(world, random, world.getHeight(this.position.add(random.nextInt(16), 0, random.nextInt(16))));
        }
    }

    private void decorateCity(World world, Random random) {
        if (random.nextInt(WastelandConfig.worldgen.wastelandTreeSpawnRate * 20) + 8 == 0) {
            this.radioTower.generate(world, random, world.getHeight(this.position.add(random.nextInt(8), 0, random.nextInt(8))));
        }
        if (random.nextInt(WastelandConfig.worldgen.wastelandTreeSpawnRate * 13) + 6 == 0) {
            this.fireStation.generate(world, random, world.getHeight(this.position.add(random.nextInt(8), 0, random.nextInt(8))));
        }
        if (random.nextInt(WastelandConfig.worldgen.wastelandTreeSpawnRate * 15) + 4 == 0) {
            this.scrapYard.generate(world, random, world.getHeight(this.position.add(random.nextInt(8), 0, random.nextInt(8))));
        }
    }
