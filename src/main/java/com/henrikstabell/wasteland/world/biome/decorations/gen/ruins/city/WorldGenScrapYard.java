 ...
 */
public class WorldGenScrapYard extends WorldGenerator {
    ...
    public boolean generate(World world, Random rand, BlockPos position) {
        ...
        Template template = templatemanager.getTemplate(minecraftserver, new ResourceLocation(Wasteland.MOD_ID + ":" + "scrapyard"));
