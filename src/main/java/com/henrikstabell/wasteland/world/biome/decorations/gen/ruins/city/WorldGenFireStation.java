 ...
 */
public class WorldGenFireStation extends WorldGenerator {

    protected Random rand = new Random();
    private double chance = 0.005D;
    ...
    public boolean generate(World world, Random rand, BlockPos position) {
        ...
        Template template = templatemanager.getTemplate(minecraftserver, new ResourceLocation(Wasteland.MOD_ID + ":" + "fire_station"));
