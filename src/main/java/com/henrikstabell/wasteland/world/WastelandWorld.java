...
import com.henrikstabell.wasteland.world.type.WorldTypeWasteland;
...
public class WastelandWorld {
    ...
    public static void init() {
        ...
        if (WastelandConfig.biomes.wastelandMountainsEnabled) {
            apocalypse_mountains = register("Wasteland Mountains", new BiomeGenMountains(new Biome.BiomeProperties("Wasteland Mountains").setTemperature(-0.5F).setBaseHeight(0.09F).setHeightVariation(0.03F).setWaterColor(10255379).setRainfall(0.5F)));
        }
        ...
        apocalypse_desert = register("Wasteland Desert", new BiomeGenDesert(new Biome.BiomeProperties("Wasteland Desert").setTemperature(-0.5F).setBaseHeight(0.09F).setHeightVariation(0.05F).setWaterColor(9410739).setRainfall(0.5F)));
